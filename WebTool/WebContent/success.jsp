<%@ page session="true" language="java" contentType="text/html; charset=gbk" import="java.util.*, com.webtool.dao.MsgDaoImpl,
...
<div class="jumbotron">
  ...
  <p style="margin-left:18%">Hi,<%=session.getAttribute("username") %> !!</p> 
  <button style="margin-left:18%; padding:5px; border: 1px solid gray; border-radius:5px" onclick="refresh()">Refresh</button> 
...
<div class="row">
    ...
    <div class="col-sm-8" >
	    ...
	    <form id="myform" action=<%="/WebTool/Chat?name="+session.getAttribute("username") %>  method="post">
		    <fieldset class="row">
		    	
		    	<div class="col-sm-1" style="font:Serif; font-size:20px"><%=session.getAttribute("username") %>:</div> 
		    	<div class="col-sm-10">
